...
The backreacted geometry is given by the locus where we further remove the locus where the coordinated $u_i,w_j$ are zero; this is an open subset that we denote by $X^0 \subset X$.
