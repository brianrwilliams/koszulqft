...
A characterization of the global symmetry algebra will follow from the computation of OPE's of the boundary CFT. As in the examples of \cite{CostelloGaiotto, CP}, this global symmetry algebra is large enough to fix the \textit{planar} 2 and 3-point functions\footnote{In fact, at infinite$-N$ the 2-point functions in \cite{CP} were shown to vanish; the same argument goes through in this case.}.
