...
\natalie{note, we should carefully check signs and normalizations against the N=4 superconformal algebra, etc.}
...
If $r = m = 0, s \neq 0$: 
\brian{should $r,m$ be zero in this equation?}
\begin{align}
...
\end{align}
If $n = s = 0, r \neq 0$: \brian{should $n,s$ be zero in this equation?}
\begin{align}
...
\end{align}
\natalie{Probably some of these can be written better with epsilon symbols and Pauli matrices to account for their $SU(2)$ reps, as in the N=4 SCA?}
\brian{should $r,s$ be zero in this equation?}
