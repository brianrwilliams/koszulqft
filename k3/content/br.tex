...
\natalie{check if you agree}
\brian{I still don't understand the role of the flux}
...
\beqn
\til J^i [0,0](0) \til J^j [1,1](z) \simeq \cdots + \eps^{ij} \frac1{z^2} \Hat{F}^2 .
\eeqn
...
We return to the operators $J[r,s]$ whose modes, before taking into account the backreaction, comprise the infinite-dimensional Lie algebra $L^R \lie{w}_\infty$ that we defined in section \ref{s:JJtree}.
