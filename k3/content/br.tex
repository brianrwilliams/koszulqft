...
One can alternatively directly compute the corresponding integrals corresponding to the $TT$ (after putting them on-shell) and $GG$ OPEs and find precisely the remaining central extension terms (after fixing the normalization of $N$). 
...
\eeqn
At the level of the constrained (on-shell) operators, this becomes 
\beqn
J[1, 0](0)J[1, 2](z) \sim \cdots + \frac{2N}{z^2}
\eeqn
\beqn
J[0, 1](0)J[2, 1](z) \sim \cdots - \frac{2N}{z^2}.
\eeqn
