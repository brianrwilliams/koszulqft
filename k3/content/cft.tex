...
\Omega^{0,\bu}(\Sigma, \underline{\rm Ext}_{\cO_Z}(\cO_\Sigma^{\oplus N}))[1] \simeq \Omega^{0,\bu}\left(\Sigma, \lie{gl}(N) \otimes \wedge^\bu \cN_\Sigma\right) [1] 
\eeqn
...
\beqn
\label{eqn:open15}
\Omega^{0,\bu}\left(\Sigma, \underline{\op{Ext}}_{\cO_X} \left(\cO_Y , \cO_\Sigma^{\oplus N}\right) \right) .
\eeqn
