...
Proceeding as above by working in the Fourier dual odd coordinates and working with on-shell fields, we see that there must be a term in the $JJ$ OPE of the form
\beqn
\til{J}^i[0,0](0,\what\eta^a) \til{J}^j [0,0] (z,\what\eta'^a) \simeq \epsilon^{ij} \frac1z \what F (\what\eta^a + \what\eta'^a) .
\eeqn
Similarly, there must be a term in the GG OPE of the form
\beqn
