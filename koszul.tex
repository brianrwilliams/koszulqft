...
It remains to see that there are non trivial degrees of freedom present for the ghost $\chi$. 
Recall that $\chi$ must also be constant along $\RR$ and holomorphic along $\PP^1$ 
\brian{I messed something up, I need to fix this}
...
\brian{COMMENTED OUT IS OLD TEXT A LOT IS PROBABLY REPETITIVE!}
