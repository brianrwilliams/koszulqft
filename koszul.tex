...
Applying our analysis from \S \ref{s:lines} is almost trivial in this case. We have two putative MC elements to apply the MC equation to:  $\partial_z^n \chi^a \otimes J_a[n]$,  $\partial_z^n \phi_a \otimes K^a[n]$. 
