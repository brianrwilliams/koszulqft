...
The addition of such an operator $\til{Q}$ would be a very general way to formulate the notion of a coupling between theories $\cA$ and $\cB$. \natalie{How general? Why is this natural (mathematically, since this is non-obvious physically)? Describe more general deformations vs. couplings here, perhaps?}
...
We will refer to such deformations as Hamiltonian.  \natalie{I think Hamiltonian is already deleted in your copy of the file, but adding a note just in case.}
\end{itemize}
