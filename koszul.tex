...
Modulo $\hbar^2$, this proposition is a generators and relations description of the graded algebra 
\[
U(\fg[\ep][z])
\]
where the linear generators are $J_a[k] = z^k \ft_a$ and $K_a [k] = \ep z^k \ft_a$. 

\subsection*{Feynman diagram interpretation}

The classical commutation relation 
\[
[J_a [k] , J_b [\ell]] = f_{ab}^c J_{c} [k+\ell]
\]
is equivalent to the cancellation of the gauge variation of the Feynman diagrams in Figure \ref{fig:cancel1}.
\begin{figure}
	\begin{tikzpicture}
	\begin{scope}
