...
It is an exercise \natalie{not easy for physicists :) but do we want to do it here?} \brian{i can prove it using a spectral sequence, but maybe that's too much to do here...} to see that even for a more general superpotential $W$ the result still holds that $\cA^! \simeq \cA$.
