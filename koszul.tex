...
\subsection{Koszul duality and the universal line defect}
...
\[
\sum_{n \geq 0} \int_{\RR \times \{z=0\}} \frac{1}{n!} J_a [n] \partial_z^n A^a_t + \sum_{n \geq 0} \int_{\RR \times \{z=0\}} \frac{1}{n!} K_a[\ell] \partial_z^n B_t^a 
\] 
