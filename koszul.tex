...
\[
\d J_a[n] = \hbar \sum_{r + s = n-1} \kappa^{bc} f_{ab}^d J_c[r] K_d[s] .
\]
...
\[
\d K_a[n] = \hbar \sum_{r + s = n-1} \kappa^{bc} f_{ab}^d f K_c[r] K_d[s] .
\]
...
\[
\d K_a[n] = \hbar \sum_{r + s = n-1} \kappa^{bc} f_{ab}^d K_c[r] K_d[s] .
\]
