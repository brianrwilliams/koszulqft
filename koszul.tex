...
In a completely analogous way, one proves that the Koszul dual of the algebra of polynomials in $n$ bosonic variables, which form a basis for a vector space $V$, is the algebra of polynomials in $n$ fermionic variables. 
...
The classical BRST operator is \brian{write it}

In a more invariant way, the BRST complex of local operators is equivalent to the Chevalley--Eilenberg complex for the graded Lie algebra $\fg[\ep][[z]]$:
\[
