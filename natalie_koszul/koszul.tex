...
To compute the weight, we first introduce some notation. 
The propagator for the theory is given by 
\[
P(t,z) = \frac{\zbar \d t - t \d \zbar}{(|z|^2 + t^2)^{3/2})} .
\]
\brian{explain or just cite the formula}

Consider the simplest case of the one-loop weight of the diagram in Figure \ref{fig:oneloop}
\[
